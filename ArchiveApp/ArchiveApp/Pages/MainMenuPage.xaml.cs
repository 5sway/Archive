...
namespace ArchiveApp
{
    public partial class MainMenuPage : Page
    {
        ...
        private void HandleReportOptions(string format, bool isTableFormat, List<string> tables, Dictionary<string, List<int>> selectedRecordIds, DateTime? startDate, DateTime? endDate, string defaultFileName)
        {
            try
            {
